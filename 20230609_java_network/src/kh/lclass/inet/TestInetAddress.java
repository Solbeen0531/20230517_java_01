...
public class TestInetAddress {
	...
	public void testInetAddressEx() {
		...
		// The constructor InetAddress() is not visible 생성자
		// -> 조치 내용 : 1. singleton 확인 (주로 getInstance(), create() method 지원 확인)
		// 2. static method 즉, class method 지원 확인
		// -> 원인 : 생성자 없음. 생성자 없이 static method 즉, class에 method 지원이 됨.
